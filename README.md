...
| # | Project | Frameworks | Status |
|---|---------|-----------|--------|
| [01](./project-1-risk-register/) | Enterprise Risk Register | NIST RMF, ISO 31000 | ✅ Complete |
| [02](./project-2-compliance-gap-analysis/) | Compliance Gap Analysis | ISO 27001, SOC 2, NIST CSF | ✅ Complete |
| [03](./project-3-audit-controls/) | Internal Audit & Controls Testing | COSO, COBIT, SOC 2 | ✅ Complete |
| [04](./project-4-pci-dss/) | PCI DSS v4.0 Compliance Program | PCI DSS v4.0, NIST SP 800-53 | ✅ Complete |
| [05](./project-5-tprm/) | Third-Party Risk Management Program | ISO 27001, DORA, NIST SP 800-161 | ✅ Complete |
| [06](./project-6-hipaa/) | HIPAA Security Rule Compliance | HIPAA, HITECH, NIST SP 800-66 | ✅ Complete |
---

## 🔧 Tools & Frameworks

`ISO 27001` `SOC 2 Type II` `NIST CSF` `NIST RMF` `ISO 31000` `COSO` `COBIT 2019` `GDPR` `DORA`

---

## 📬 Contact

Open to GRC Analyst, Risk Analyst, and Compliance Analyst roles.  
